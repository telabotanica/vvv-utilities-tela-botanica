#!/usr/bin/env bash
# Télécharge et configure yeswiki
if [[ ! -d "/srv/www/wikini" ]]; then
	echo -e "\nDownloading yeswiki, see https://github.com/telabotanica/yeswiki"
	cd /srv/www
	git clone --depth=1 "https://github.com/telabotanica/yeswiki" wikini
...
$wakkaConfig = array (
  ...
  'base_url' => 'http://local.tela-botanica.test/wikini/wakka.php?wiki=',
  'rewrite_mode' => '0',
  'meta_keywords' => '',
  'meta_description' => '',
  'action_path' => 'actions',
  ...
  'sso_url' => 'http://local.tela-botanica.test/service:annuaire:auth/',
  'use_sso' => '1',
